...
const About = () => (
    <div className="h-screen v-screen" style={{
        ...
        <div className="grid grid-cols-1 gap-5 place-items-center h-screen">
            <div className="w-10/12 sm:w-10/12 md:w-10/12 lg:w-8/12 sm:h-5/6 h-4/6  flex justify-center bg-black bg-opacity-80 p-5 xl:p-20 font-normal text-white mb-3 stick-font sm:text-xl md:text-3xl lg:text-3xl xl:text-4xl text-md">
                <div className="inline-block text-center">
                    <IoMdQuote className="mx-auto p-3 w-16 h-16 mb-5 mt-5 md:mb-10 md:mt-10 lg:mb-15 lg:mt-15 xl:mb-15 xl:mt-15" />
