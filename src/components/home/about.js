...
const About = () => (
    <div className="h-screen v-screen" style={{
        ...
        <div className="grid grid-cols-1 gap-3 place-items-center h-screen">
            <div className="w-10/12 sm:w-10/12 md:w-10/12 lg:w-8/12 sm:h-5/6 h-3/4 lg:h-4/6  flex justify-center bg-black bg-opacity-80 py-10 px-5 xl:p-20 font-normal text-white mb-3 stick-font text-base sm:text-xl md:text-2xl 2xl:text-3xl">
